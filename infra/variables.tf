...
variable "archiemcp_function_source_dir" {
  description = "The local directory (relative to this infra/ directory) containing the ArchieMCP function source code."
  type        = string
  default     = "../../functions/archiemcp" # Adjusted path
}
